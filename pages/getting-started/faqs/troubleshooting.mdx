...
<AccordionGroup>
  <Accordion title="@kash_bot isn't responding to my commands">
    ...
    **Quick Solutions:**
    ...
    2. **Verify Command Format:** Use exact command syntax (e.g., "bet $10 YES on market 123")
    3. **Wait and Retry:** Wait a few minutes and try again
    4. **Check Bot Status:** Look for maintenance announcements in Discord
    
    **Command Format Examples:**
    ```
    bet $50 YES on market 123
    bet 25 USDC NO on market 456
    balance
    help
    ```
    
    **Alternative Access:**
    - **Web Dashboard:** Use kash.bot website for betting
  ...
  <Accordion title="My bet didn't go through">
    ...
    **Troubleshooting Steps:**
    ...
    3. **Check Command:** Ensure proper bet command format
    4. **Wait for Confirmation:** Allow time for blockchain confirmation
    
    **Bet Command Requirements:**
    ...
    **Alternative Betting:**
    - **Web Interface:** Use dashboard for complex bets
    - **Mobile Browser:** Mobile-optimized betting interface
...
<AccordionGroup>
  ...
  <Accordion title="Geographic restrictions">
    ...
    **Understanding Restrictions:**
    - **U.S. Users:** Limited to $10 maximum bet per transaction
    ...
    **U.S. User Limitations:**
    - **Bet Limit:** Maximum $10 per transaction
...
<AccordionGroup>
  ...
  <Accordion title="Transaction failures">
    ...
    **Prevention:**
    ...
    - **Market Timing:** Check market status before betting
