...
<AccordionGroup>
  <Accordion title="Is Kash available in my country?">
    ...
    **Regional Considerations:**
    - **Soft Geofencing:** U.S. users have limited functionality (maximum $10 bets)
    ...
    **Restricted Activities:**
    ...
    - **Regulated Events:** Compliance with local sports betting and gambling laws
...
<AccordionGroup>
  ...
  <Accordion title="What are the current geographic restrictions?">
    ...
    **United States:**
    - **Limited Functionality:** Maximum $10 bet limit per transaction
    - **Soft Geofencing:** Access maintained but with reduced features
    - **Regulatory Compliance:** Designed to comply with U.S. gambling regulations
...
<AccordionGroup>
  ...
  <Accordion title="What about data privacy?">
    ...
    **Privacy Considerations:**
    - **Public Blockchain:** All betting activity is publicly visible
