...
<AccordionGroup>
  ...
  <Accordion title="How do session keys and spending limits work?">
    ...
    **Session Keys:**
    ...
    - **Limited Scope:** Only for betting actions, not withdrawals or large transactions
    ...
    **Spending Limits:**
    - **Daily Limits:** Maximum amount that can be bet per day through automated sessions
    - **Transaction Limits:** Maximum size per individual bet without manual approval
    ...
    **How It Works:**
    ...
    - Total daily bets > $50 → Manual approval required
    ```
    
    **Security Benefits:**
    - **Convenience without Risk:** Fast betting for small amounts, security for large ones
