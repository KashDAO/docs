...
<AccordionGroup>
  ...
  <Accordion title="How do I check my wallet balance?">
    ...
    **Balance Information Includes:**
    - **Available Balance:** USDC available for betting
  ...
  <Accordion title="What currencies does Kash support?">
    ...
    **Primary Trading Currency:**
    - **USDC (USD Coin):** Primary currency for all betting activities
    ...
    **Currency Conversion:**
    - **Automatic Conversion:** Seamless conversion to USDC for betting
...
<AccordionGroup>
  <Accordion title="How do I deposit funds?">
    ...
    **Deposit Process:**
    ...
    4. **Confirmation:** Funds available for betting within minutes
  ...
  <Accordion title="Are there minimum balance requirements?">
    ...
    **Account Minimums:**
    ...
    - **Recommended Starting:** $10+ for meaningful betting
    - **Dust Amounts:** Small amounts handled efficiently
    
    **Betting Minimums:**
    - **No Minimum Bet:** Place bets of any size
    ...
    **Balance Optimization:**
    - **Efficient Betting:** Optimize bet sizes for fee efficiency
...
<AccordionGroup>
  ...
  <Accordion title="How do I track my transaction history?">
    ...
    **Transaction Details:**
    - **Bet Placements:** All betting activity with outcomes
    ...
    **Historical Analysis:**
    ...
    - **Market Participation:** Categories and frequency of betting
