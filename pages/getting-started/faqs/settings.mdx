...
<AccordionGroup>
  ...
  <Accordion title="What notification settings are available?">
    ...
    **Bot Notifications:**
    - **Bet Confirmations:** Notifications when bets are placed
  ...
  <Accordion title="How do I manage my privacy settings?">
    ...
    **Public Information:**
    ...
    - **Transaction History:** All betting activity is publicly visible on blockchain
...
<AccordionGroup>
  ...
  <Accordion title="How do I export my data?">
    ...
    **Available Data:**
    - **Transaction History:** Complete record of all betting activity
...
<AccordionGroup>
  ...
  <Accordion title="How do I reset my settings?">
    ...
    **What Stays:**
    ...
    - **Transaction History:** All betting history preserved
