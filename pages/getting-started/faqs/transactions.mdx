...
<AccordionGroup>
  <Accordion title="How do transactions work on Kash?">
    ...
    **Transaction Flow:**
    1. **Bet Placement:** Submit prediction via @kash_bot or web interface
    ...
    **Supported Currencies:**
    - **Primary:** USDC (USD Coin) for all betting activities
    ...
    **Transaction Types:**
    - Bet placement and position management
    - Deposits and withdrawals
    - Market creation and curation
    - Reward claims and distributions
    
    **Processing Times:**
    - Bet placement: Instant execution
  ...
  <Accordion title="What fees does Kash charge?">
    ...
    **Platform Fees:**
    - **Trading Fee:** 2% on all trades (buying or selling shares)
...
<AccordionGroup>
  <Accordion title="How do I view my transaction history?">
    ...
    **Transaction Details Include:**
    - Bet amount, odds, and potential payout
  ...
  <Accordion title="Can I cancel or modify a transaction?">
    ...
    **Transaction Immutability:**
    ...
    - No reversal mechanism for completed bets
    - Smart contracts execute automatically upon confirmation
    
    **Early Exit Options:**
    - **Sell Position:** Exit bet before market resolution (if liquidity available)
    ...
    **Before Confirmation:**
    - Double-check bet details before final submission
    - Verify market terms and resolution criteria
    - Confirm bet amount and potential payout
    - Review transaction summary carefully
    
    **Risk Management:**
    - Start with smaller bet amounts to learn platform
    - Use position sizing appropriate to risk tolerance
    - Consider market volatility when placing bets
...
<AccordionGroup>
  <Accordion title="How does gas sponsorship work?">
    ...
    **Covered Transactions:**
    - **Bet Placement:** All betting activity
