...
<Tabs>
    ...
    **Main Community Channels**
    ...
    <AccordionGroup>
      ...
      <Accordion title="Discord - Community Hub">
        ...
        **How to Join:**
        - Join via [invite link](https://discord.gg/bUtjbJNqPQ)
  ...
  <Tab title="Official Links">
    **Quick Access Directory**
    ...
    | **Discord** | [Kash](https://discord.gg/bUtjbJNqPQ) | Community hub |
...
<AccordionGroup>
  <Accordion title="Quick Start Checklist">
    ...
    **Essential Steps:**
    ...
    2. **Join [Discord](https://discord.gg/bUtjbJNqPQ)** - Connect with the community
...
<CardGroup cols={2}>
  <Card
    title="Join Discord"
    icon="discord"
    href="https://discord.gg/bUtjbJNqPQ"
  >
