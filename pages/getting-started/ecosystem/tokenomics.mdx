...
<Tabs>
  <Tab title="Core Functions">
    ...
    **Betting Currency:**
    - Alternative to USDC for placing bets
    - Automatic swap to USDC when betting with $KASH
    - Seamless betting experience across all markets
  ...
  <Tab title="Earning Opportunities">
    ...
    **AI-Driven Engagement Rewards:**
    - Variable ratio rewards for frequent betting using gambling neural behavioral techniques
...
<AccordionGroup>
  ...
  <Accordion title="Revenue Generation from Lending and Swaps">
    ...
    **Auto Swap Revenue Model:**
    - **0x Protocol Integration:** Users can bet with any ERC-20 token (ETH, WETH, DAI, etc.)
    - **Automatic Conversion:** Tokens instantly swapped to USDC for betting
