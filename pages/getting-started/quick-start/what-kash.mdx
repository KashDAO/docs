...
<AccordionGroup>
  ...
  <Accordion title="Social Media Native">
    **Bet directly from X without leaving your feed:**
    - Reply to market posts with "YES \$50" or "NO \$100"
...
<Steps>
  <Step title="Event Detection & Signal Processing">
    ...
    **How the 5 AI Agents Work Together:**
    ...
    - **Sports Agent:** Tracks game schedules, player news, injury reports, and betting market movements
    ...
    **Signal Processing:**
    ...
    - **Gambling-Neural Behavioral Score** based on engagement, uncertainty, and viral potential
  ...
  <Step title="Trade Execution & Price Discovery">
    **Social Trading Begins**
    - **Natural Language Betting:** Users place bets by replying "YES \$50" or "NO \$100" to market posts
...
<Tabs>
  ...
  <Tab title="Payouts & Fees">
    ...
    **Example Calculation:**
    ```
    Your trade: 100 YES shares at $0.60 = $60 cost
...
<AccordionGroup>
  <Accordion title="Blockchain Infrastructure">
    **Built on Base for Performance**
    ...
    - **0x Integration:** Automatic token swaps for seamless betting
  </Accordion>
  ...
  <Accordion title="AI-Powered Operations">
    **Intelligent Market Management**
    ...
    - **Natural Language Processing:** Understands betting commands in conversation
...
- **Zero Learning Curve:** Bet using natural conversation on familiar social media
...
- **Leveraged Betting**: Available for qualified users
