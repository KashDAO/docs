...
<AccordionGroup>
  ...
  <Accordion title="Fee Timing">
    **When fees are charged throughout your trading journey**
    - **Bet placement:** 2% fee charged at time of trade
...
## Payout Example
```
Your bet: $100 on YES at $0.40 per share
...
<AccordionGroup>
  <Accordion title="Full Market Win">
    **Your prediction was correct at resolution**
    - **Event outcome matches your bet** (YES/NO)
...
<AccordionGroup>
  <Accordion title="Early Bird Advantage">
    **Bet before consensus forms for better opportunities**
    - **Better odds available** in early markets before prices stabilize
  ...
  <Accordion title="Smart Position Sizing">
    **Optimize your bet amounts for sustainable growth**
...
<Tabs>
  <Tab title="Performance Analytics">
    **Monitor your prediction success with detailed metrics**
    ...
    |--------|-------------|----------------|
    | **Win Rate** | Percentage of winning bets | Measures prediction accuracy |
    ...
    | **Average Bet** | Typical position size | Shows risk management |
  ...
  <Tab title="Leaderboards & Recognition">
    **Compete with other predictors and earn recognition**
    ...
    - **Best Win Rates** - Most accurate predictors (min. 50 bets)
    ...
    - **Attract copiers** who want to follow your bets
  </Tab>
</Tabs>
