...
<Tabs>
  ...
  <Step title="Wallet Created!">
    ...
    - Ready to fund and start betting
  </Step>
</Steps>
  </Tab>
...
<AccordionGroup>
  ...
  <Accordion title="Seamless Experience">
    ...
    - **Instant availability** - start betting immediately
  ...
  <Accordion title="Advanced Features">
    ...
    - **Automatic token swapping** - bet with any supported token
...
<CardGroup cols={2}>
  ...
  >
    Discover prediction markets to bet on
  </Card>
</CardGroup>