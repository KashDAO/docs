---
title: 'Predicting'
description: 'How to place bets and make predictions'
icon: 'crystal-ball'
---

<Note>
Turn your insights into returns - making predictions on Kash is as simple as replying to a tweet.
</Note>
...
<AccordionGroup>
  <Accordion title="Price = Probability">
    ...
    - **Prices change** as people place bets and new information emerges
  </Accordion>
  <Accordion title="Your Potential Returns">
    ...
    - **If NO wins:** You lose your bet entirely
    - **Example:** \$100 bet → 138.89 shares → \$138.89 if correct
  </Accordion>
  <Accordion title="Market Dynamics">
    - **Early bets** often get better odds before consensus forms
    - **Breaking news** can rapidly shift prices
    - **Large bets** move odds more than small ones
    - **Smart money** keeps markets efficient through arbitrage
    - **Social sentiment** influences betting patterns
  </Accordion>
</AccordionGroup>
...
<Tabs>
  <Tab title="Finding Markets">
    **Discover active prediction markets**
    ...
    ## Through Your X Feed
    - **Follow @kash_bot** - Turn on notifications for instant alerts
    ...
    Tweet or DM @kash_bot with:
    - **"Show me markets"** - See all active markets
    - **"What can I bet on?"** - Get personalized suggestions
  ...
  <Tab title="Placing Bets">
    **Simple social betting through replies**
    
    ## Easy Reply Format
    Just reply to any market with:
    - **"YES 50"** - Bet $50 that the event will happen
    - **"NO 100"** - Bet $100 that it won't happen
    - **"YES $25"** - Dollar sign is optional
    - **"no 10"** - Case doesn't matter
    
    ## Automatic Execution
    1. **@kash_bot confirms** your betting intent
  ...
  <Tab title="Advanced Features">
    **Power user betting options**
    
    ## Leverage Betting
    - **Bet up to 2x your balance** with qualifying accounts
    - **Higher risk, higher reward** potential
    - **5% interest fee** paid to treasury
    - **Example:** "YES 200 2x" to leverage a $200 bet
    
    ## Private Predictions
    **DM @kash_bot for discreet betting:**
    - **No public announcements** of your bet
    - **Same execution process** as public bets
    - **Ideal for large positions** that might move markets
    - **Maintains betting anonymity** while staying social
...
<AccordionGroup>
  <Accordion title="Information Edge">
    **Leverage knowledge for better predictions**
    - **Research before betting** - Read news, analyze trends, understand context
    - **Follow reliable sources** - Trust verified accounts and expert analysis
    - **Spot market inefficiencies** - Find odds that don't match reality
  ...
  <Accordion title="Portfolio Approach">
    **Manage risk like a professional trader**
    ...
    - **Don't bet entire balance** - Keep reserves for better opportunities
    - **Take profits regularly** - Lock in gains instead of letting them ride
    - **Manage risk carefully** - Size bets according to confidence level
  </Accordion>
  <Accordion title="Social Signals">
    **Learn from the crowd and contrarian opportunities**
    - **Watch influencer bets** - Follow successful predictors' strategies
...
<AccordionGroup>
  ...
  <Accordion title="Sell Before Close">
    **Exit positions strategically**
    ...
    - **Cut losses if needed** - Minimize damage from bad bets
    - **Reply "sell my YES"** - Simple command to exit position
  ...
  <Accordion title="Unlimited Trading">
    **Trade without restrictions**
    - **No daily limits** on bet placement
...
<Tabs>
  <Tab title="Quick Commands">
    **Master these basic commands for efficient trading**
    ...
    |--------|---------|---------|
    | Bet on YES | `"YES [amount]"` | `"YES 50"` |
    | Bet on NO | `"NO [amount]"` | `"NO 100"` |
    | Check balance | `"balance"` | `"balance"` |
    | See positions | `"my bets"` | `"my bets"` |
    ...
    | Leverage bet | `"YES [amount] 2x"` | `"YES 200 2x"` |
  </Tab>
  ...
  <Tab title="Pro Tips">
    **Advanced strategies for experienced predictors**
    ...
    ## Timing Your Bets
    - **Early markets** often have better odds before consensus forms
...
<Tip>
Every expert predictor started with their first bet. Start small, learn the dynamics, and let your edge compound over time!
</Tip>
