...
<AccordionGroup>
  <Accordion title="Complete Account Management">
    ...
    **Account Operations:**
    - "What's my transaction history?" → Complete betting and win/loss records
  ...
  <Accordion title="Effortless Market Discovery">
    ...
    **General Discovery:**
    - "What can I bet on?" → Personalized market recommendations
    - "Show me trending markets" → Popular and high-volume opportunities
    - "Any good bets today?" → Daily curated market suggestions
    
    **Category-Specific Requests:**
    - "Crypto markets?" → Cryptocurrency and DeFi prediction opportunities
    - "Sports bets available?" → Athletic events and tournament markets
    ...
    **Personalized Suggestions:**
    - AI learns your interests from X activity and betting history
    - Proactive notifications about relevant new markets
    - Custom alerts based on your prediction categories
  </Accordion>
  
  <Accordion title="Natural Betting Experience">
    **Place bets using everyday language**
    
    **Simple Betting Commands:**
    - "YES $100" → Bet $100 that the event will happen
    - "NO 50" → Bet $50 that it won't happen  
    - "I think yes, betting 25 dollars" → Conversational betting
    ...
    **Smart Understanding:**
    ...
    - Remembers your preferences and betting patterns
...
<Tabs>
  <Tab title="Complete Accessibility">
    ...
    **Universal Understanding:**
    - Bet using your own words and expressions
    ...
    **Instant Access:**
    - Start betting immediately without tutorials
  ...
  <Tab title="Social Integration">
    **Betting within conversations**
    
    **In-Context Participation:**
    - Bet directly in trending topic discussions
...
<AccordionGroup>
  <Accordion title="Setting Up Your Account">
    **Getting started conversation**
    ...
    ```
    You: "How do I start betting on Kash?"
    ...
    You: "Done! Now what?"
    @kash_bot: "Perfect! Your wallet is ready. To start betting, you'll need to fund it.
  ...
  <Accordion title="Finding and Placing Bets">
    **Market discovery and betting**
    ...
    @kash_bot: "How much would you like to bet on YES?"
...
<Tip>
Natural language processing is what makes Kash revolutionary. Whether you say "YES $100" or "I'll bet a hundred bucks this happens," ElizaOS understands your intent and executes it perfectly. This technology transforms social media into the world's most powerful prediction market interface.
</Tip>
