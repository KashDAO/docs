...
<Tabs>
  <Tab title="AI-Driven Creation">
    ...
    **Creation Process:**
    1. **Signal Detection** - AI identifies trending topics with betting potential
  ...
  <Tab title="User Suggestions">
    ...
    **How to Suggest Markets:**
    ...
    - **Natural conversation** - AI detects betting intent in discussions
...
<Steps>
  ...
  <Step title="Automated Resolution">
    **AI-Powered Settlement with Cryptographic Proofs**
    ...
    - **Platform fee:** 2% charged on all trades
  </Step>
</Steps>
...
<AccordionGroup>
  ...
  <Accordion title="Gasless Trading">
    ...
    **What's Covered:**
    ...
    - Bet placement and position changes
  ...
  <Accordion title="Slippage Protection">
    ...
    **Multi-Layer Protection:**
    - **Automatic Slippage Limits:** 5% maximum slippage on social media bets
    ...
    **How It Works:**
    ...
    ```
         ...
         **Protection Levels:**
     - **Small Trades (under $50):** 2% maximum slippage tolerance
     - **Medium Trades (\$50-\$500):** 5% maximum slippage tolerance
     - **Large Trades (over $500):** Automatic routing to RFQ system
     - **Institutional Trades (over $1000):** MEV protection with batch execution
