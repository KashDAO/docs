...
<Tip>
Prefer the CLI for issuance? You can also issue keys via the `@kashdao/cli` (`kash` command) once you've authenticated it with a Privy session. See the [CLI guide](/developer-docs/rest-api/sdks/cli).
</Tip>
