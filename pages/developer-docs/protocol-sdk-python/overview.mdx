...
- [**Quickstart — EOA mode**](/developer-docs/protocol-sdk-python/quickstart-eoa) — vanilla EIP-1559 from a plain wallet. Canonical Hummingbot path.
- [**Quickstart — Smart-account mode**](/developer-docs/protocol-sdk-python/quickstart-smart-account) — ERC-4337 v0.7 with a bundler.
- [**Hummingbot integration**](/developer-docs/protocol-sdk-python/hummingbot) — full strategy walkthrough.
- [**TypeScript SDK**](/developer-docs/protocol-sdk/overview) — same protocol, TypeScript instead of Python.
