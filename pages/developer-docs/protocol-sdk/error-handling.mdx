...
- [**Cross-language parity**](/developer-docs/protocol-sdk/cross-language-parity) — error class names and codes match the Python SDK exactly.
- The full `ErrorCode` enum lives in
  [`packages/protocol-sdk/src/shared/error-codes.ts`](https://github.com/KashDAO/protocol-sdk-typescript/blob/main/src/shared/error-codes.ts).
