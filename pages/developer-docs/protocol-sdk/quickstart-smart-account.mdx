...
- [**EOA quickstart**](/developer-docs/protocol-sdk/quickstart-eoa) — vanilla EIP-1559, no bundler, lower per-trade overhead.
- [**Error handling**](/developer-docs/protocol-sdk/error-handling) — typed error hierarchy.
- [**Cross-language parity**](/developer-docs/protocol-sdk/cross-language-parity) — UserOp v0.7 hashes are byte-equal across the TS and Python SDKs by construction.
