...
Kash is a revolutionary prediction markets platform that brings betting directly to social media conversations. Built on Base (Coinbase's L2), Kash enables **permissionless market creation** where anyone can instantly create and trade on prediction markets without gatekeepers or approval processes.

### Key Features

- 🤖 **AI-Powered**: Automated market creation and resolution using advanced AI agents
- 🐦 **Social Native**: Bet directly from X (Twitter) using natural language with @kash_bot
