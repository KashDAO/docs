...
<Tabs>
  <Tab title="Treasury Management">
    ...
    **Treasury Architecture:**
    ...
    - **Community Rewards Module:** Manages grants and community incentives
...
<AccordionGroup>
  ...
  <Accordion title="Community Incentives">
    ...
    **Governance Rewards:**
    - **Staking** for active token holders
    - **Participation bonuses** for consistent voting activity
    - **Enhanced governance rights** through yield farming
    - **Community recognition** for valuable contributions
    
    **Community Participation:**
    - **Active governance** shapes the platform's future
    - **Community growth** through organic engagement
    - **Validator staking** for infrastructure support
