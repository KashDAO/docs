...
<Note>
Kash features community competitions and leaderboards that recognize top performers. All competitions are part of the Community Incentives program and designed to drive engagement and skill development.
</Note>
...
<AccordionGroup>
  <Accordion title="Performance Tracking">
    ...
    **Recognition Benefits:**
    ...
    - **Performance-based recognition** on public leaderboards
  </Accordion>
  ...
  <Accordion title="Friend-Based Competition">
    ...
    **Friend Comparisons:**
    ...
    - **Leaderboard updates** when friends place predictions or achieve milestones
    - **Collaborative challenges** and group prediction activities
    - **Peer recognition** and social validation systems
    
    **Social Features:**
    - **Friend activity feeds** for market activity
    - **Follow top predictors** to see their activity on the leaderboard
...
<Tabs>
  <Tab title="Market Creator Competitions">
    ...
    **Creator Recognition:**
    - **Weekly competitions** recognize top-performing market creators
  ...
  <Tab title="Prediction Performance">
    ...
    **Earning Opportunities:**
    - **Recognition** for competition winners
...
<AccordionGroup>
  <Accordion title="Community Participation">
    ...
    **Reward Categories:**
    ...
    - **Quality engagement** recognition for meaningful contributions
...
<AccordionGroup>
  <Accordion title="Competition Rewards">
    ...
    **Recognition Categories:**
    - **Competition winners** receive public recognition and leaderboard status
    - **Consistent performers** receive ongoing leaderboard prominence
    - **Community contributors** receive participation recognition
    - **Platform promoters** receive community acknowledgment
    
    **Long-term Benefits:**
    - **Reputation building** through competition success
    - **Community leadership** opportunities for top performers
    - **Enhanced reputation** through improved platform status
...
<Warning>
Competition formats and recognition criteria are subject to DAO governance decisions and may evolve based on community feedback. Focus on building skills and community engagement.
</Warning>
