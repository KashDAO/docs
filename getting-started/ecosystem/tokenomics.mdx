...
<Tabs>
  ...
  <Tab title="Community Growth">
    **$KASH in the Ecosystem**

    **Governance Voting:**
    - $KASH holders vote on protocol upgrades, fee structures, and treasury allocation
    - Voting weight increases with staking duration
    - Active governance participation shapes the platform's direction

    **Staking:**
    - Stake $KASH for enhanced governance weight
    - Flexible lock durations from 30 days to 365 days

    **Community Incentives Allocation:**
    - 25% of total supply is allocated to Community Incentives
    - Supports ecosystem growth through various programs announced via official channels
    - Allocation governed by DAO decisions and community voting
  </Tab>
  
  <Tab title="Staking & Governance">
    **Lock Periods and Governance Weight**
...
<AccordionGroup>
  ...
  <Accordion title="Treasury Architecture">
    ...
    **Module Interactions:**
    ...
    - **Community Rewards Module:** Distributes bought-back tokens for community incentives
...
<CardGroup cols={2}>
  ...
  >
    Learn about the incentives program
  </Card>
  <Card
    title="Governance"
    icon="landmark"
