...
<AccordionGroup>
  ...
  <Accordion title="Your Potential Returns">
    ...
    - **Liquid Markets:** Markets remain liquid — you can exit positions at any time at available market rates
...
<Tabs>
  <Tab title="Finding Markets">
    **Discover active prediction markets**
    ...
    - **Browse market posts** on @kash_bot's timeline
    - **@mention @kash_bot** to get market suggestions on topics you care about
