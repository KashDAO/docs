...
<Tabs>
  <Tab title="AI-Driven Creation">
    ...
    **5 Specialized AI Personas** identify trending topics and create markets:
  ...
  <Tab title="User Suggestions">
    ...
    **What Gets Approved:**
    ...
    - Timely events resolving in no more than 30 days
...
<AccordionGroup>
  ...
  <Accordion title="Share-Based Trading">
    **Outcome Tokens as Tradeable Assets**
    ...
    - **Market Completeness:** YES + NO prices should always equal $1.00
  ...
  <Accordion title="Custom AMM Bonding Curve">
    **Revolutionary Social-Adapted Pricing Technology**
    
    Kash uses a proprietary bonding curve that revolutionizes prediction market liquidity:
    ...
    **Technical Implementation:**
    ...
    <Tip>
    Learn more about the [Custom AMM Bonding Curve](/pages/getting-started/features/custom-amm) and its revolutionary advantages.
    </Tip>
  </Accordion>
</AccordionGroup>
...
<Tabs>
  ...
  <Tab title="Liquidity System">
    ...
    **Liquidity Sources:**
    - **Primary:** Automated liquidity provision from Kash's Automated LP Vault
...
<Steps>
  <Step title="Market Creation & Validation">
    **AI-Driven Process with Quality Control**
    ...
    - **Instant Liquidity Bootstrap:** Automated LP Vault automatically deploys USDC
  </Step>
...
<Tabs>
  ...
  <Tab title="Automated LP Vault">
    ...
    **How It Works:**
    ...
    - **Principal Protection:** Mathematical verification that your original USDC is returned
    - **Yield Generation:** Earn from trading fees and external yield (Aave)
    - **Smart Rebalancing:** AI automatically adjusts positions to maintain optimal liquidity
    
    **Why Principal is Protected:**
    The vault uses concentrated liquidity that automatically rebalances around the current market price. This means you're always holding equal value of YES and NO shares, so regardless of which outcome wins, you receive the same amount back.
