...
- [**EOA quickstart**](/developer-docs/protocol-sdk-python/quickstart-eoa) — the EOA-mode Python integration the strategy above uses.
- [**Smart-account mode**](/developer-docs/protocol-sdk-python/quickstart-smart-account) — for AA-stack Python integrations.
- [**Cross-language parity**](/developer-docs/protocol-sdk/cross-language-parity) — same encoding bytes as the TypeScript SDK.
